...
class ServiceUrl {
  ...
  static const String staminaService =
      '/services/gazago/api/user-state-recoveries';
  static const String dashboardV2Service =
      '/services/gazago/api/v2/dash-board-reward-dailies';
  static const String dashboardService =
      '/services/gazago/api/dash-board-reward-dailies';
  static const String goWalletService = '/services/wallet-go/api';
  static const String onChainWalletService =
      '/services/wallet-go/api/on-chains';
