...
class Routes {
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
        name: Routes.archiveHome,
        page: () => const ArchiveHome(),
        transition: Transition.noTransition),
    GetPage(
        name: Routes.inventoryHome,
        page: () => const InventoryHome(),
        transition: Transition.noTransition),
    GetPage(
        name: Routes.shopHome,
        page: () => const ShopHome(),
        transition: Transition.noTransition),
    GetPage(
        name: Routes.leaderboardHome,
        page: () => const LeaderboardHome(),
        transition: Transition.noTransition),
  ];
}
