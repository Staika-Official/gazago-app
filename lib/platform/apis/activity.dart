...
class ActivityApi {
  static final Dio stateApi = Api.client(serviceUrl: ServiceUrl.stateService);
  ...
  static Future<Response> fetchUserStaminaRecharge(String userId, UserStaminaRechargeModel rechargeInfo) async {
    return await staminaApi.post('/users/$userId', data: rechargeInfo);
  }
}
