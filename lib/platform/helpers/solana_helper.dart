...
Future<Message> getNftTransferMessage(SolanaClient solanaClient, Ed25519HDKeyPair sender, Ed25519HDPublicKey destination, Ed25519HDPublicKey mint, int feeAmount) async {
