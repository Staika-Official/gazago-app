...
Color lightGreenColor = const Color(0xFFCDFF41);
Color purpleColor = const Color(0xFFB85DFF);
Color lightPurpleColor = const Color(0xFFB0A3FF);
...
Color pinkColor = const Color(0xFFFF74B7);
