...
class CompanyCrewLeaderboard extends StatelessWidget {
  ...
  List<Widget> renderCrewManagerLeaderboardList(CompanyCrewController controller) {
      ...
      return Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Container(
                padding: EdgeInsets.only(top: 25.sp, left: 20.sp, right: 20.sp, bottom: 18.sp),
                child: Row(
    ...
    return Material(
      ...
      child: Ink(
        decoration: BoxDecoration(
          ...
          border: Border(
            bottom: BorderSide(
              color: isMyCrew || isManager ? AppColorData.regular().colorBgPrimary : AppColorData.regular().colorBgSecondary,
              width: 1,
            ),
          ),
        ),
                            ...
                            child: Row(
                              children: [
                                ...
                                StyledText(
                                  ...
                                  fontWeight: 600,
                                  fontSize: 16,
                                  color: isMyCrew || isManager ? AppColorData.regular().colorTextBrand : Colors.white,
                                ),
                              ],
                            ),
                          ),
