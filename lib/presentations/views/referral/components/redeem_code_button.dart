                                ...
                                child: InkWell(
                                  onTap: canSubmit
                                      ? () async {
                                          ...
                                          if (code.length != 8) {
                                            hasError.value = true;
                                            errorMessage.value = 'code_must_be_exactly_8_characters'.tr();
                                            return;
                                          }
                                          ...
                                          if (code == 'ABCD1234') {
                                            ...
                                            OverlayDialog.showSuccess(
                                              title: 'success'.tr(),
                                              description: 'referral_code_redeemed_successfully'.tr(),
                                            );
                                          } else if (code == 'EXPIRED1') {
                                            // Show failure dialog
                                            OverlayDialog.showFailure(
                                              title: 'failed'.tr(),
                                              description: 'referral_code_reached_limit'.tr(),
                                            );
                                          } else {
                                            ...
                                            try {
                                              ...
                                              if (success) {
                                                ...
                                                OverlayDialog.showFailure(
                                                  title: 'failed'.tr(),
                                                  description: 'invalid_referral_code_try_again'.tr(),
                                                );
                                              }
                                            } catch (e) {
                                              ...
                                              OverlayDialog.showFailure(
                                                title: 'failed'.tr(),
                                                description: 'error_occurred_try_again'.tr(),
                                              );
                                            }
                                          }
                                        }
