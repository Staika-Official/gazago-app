      ...
      child: DefaultContainer(
        ...
        child: Padding(
          padding: EdgeInsets.only(
              left: 16.sp, right: 16.sp, top: 16.sp, bottom: 30.sp),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Obx(() {
                        return Text(
                          controller.platform.value == 'gazago'
                              ? 'gazaGO'
                              : 'Staika wallet',
                          style: AppTextStyleData.regular()
                              .koHeadingSemiboldMd
              ...
              Obx(() {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: controller.allRequiredAgreed.value
                  ...
                  child: InkWell(
                    onTap: () => controller.allRequiredAgreed.value
                      ...
                      child: Center(
                        ...
                        style:
                            AppTextStyleData.regular().koBodyMediumXl.copyWith(
                                  color: controller.allRequiredAgreed.value
                                      ? AppColorData.regular().colorBaseBalck
                                      : AppColorData.regular().colorTextInverse,
                                ),
                      )),
                    ),
                  ),
