          ...
          children: [
            ...
            Row(
              ...
              children: [
                CircleAvatar(
                  foregroundImage:
                      controller.tik.value.logoUrl != '' ? CachedNetworkImageProvider(controller.tik.value.logoUrl!) : const Svg('assets/images/common/ico_token_tik.svg') as ImageProvider,
                  radius: 12.5,
                ),
                Padding(
